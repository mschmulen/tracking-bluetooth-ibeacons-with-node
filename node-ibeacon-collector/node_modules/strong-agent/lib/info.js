...
function connectionInfo(){
	if (nf.server_obj) {
		...
		if (nf.server_obj.getConnections) {
			nf.server_obj.getConnections(function(err, conns) {
				if (err === null) {
					nf.metric(processScope, 'Connections', [conns,tp], '');
				}
			});
		}
		else {
			var conns = nf.server_obj.connections || nf.server_obj._connections || null;
			nf.metric(processScope, 'Connections', [conns,tp], '');
		}
